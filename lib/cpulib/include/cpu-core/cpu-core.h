...
inline XMFLOAT3 CPU_GOLD				= { 1.0f, 0.92f, 0.0f};
inline XMFLOAT3 CPU_SILVER				= { 0.8f, 0.8f, 0.8f};
inline XMFLOAT3 CPU_BRONZE				= { 0.8f, 0.5f, 0.2f };
inline XMFLOAT3 CPU_CYAN				= { 0.0f, 0.95f, 0.95f };
